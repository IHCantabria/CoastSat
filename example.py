...
# region of interest (latitude, longitude in WGS84)

# name of the site
sitename = 'REYA'
with open(os.path.join("data", sitename, sitename + '_reference_shoreline.geojson'), 'r') as f:
    data = json.load(f)
with open(os.path.join("data", sitename, sitename + '_reference_shoreline.pkl'), 'wb') as f:
    refsl = pickle.dump(data, f)

kml_polygon = os.path.join("data", sitename, "{0}.kml".format(sitename))
