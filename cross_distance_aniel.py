...
finalDate = datetime(2020,2,29,0,0,0, tzinfo=pytz.utc)

output["dates"] = [date for date in dates if date < finalDate]
output["shorelines"] = output["shorelines"][0:len(output["dates"])]
output["geoaccuracy"] = output["geoaccuracy"][0:len(output["dates"])]
output["satname"] = output["satname"][0:len(output["dates"])]
output["filename"] = output["filename"][0:len(output["dates"])]
output["cloud_cover"] = output["cloud_cover"][0:len(output["dates"])]
output["idx"] = output["idx"][0:len(output["dates"])]
